...
#+begin_example
/bin/rm -rf ./mallet
/usr/bin/emacs ./mallet_end_to_end_tutorial.org --batch --eval "(require 'org)" --eval '(org-md-export-to-markdown)' --eval '(org-babel-tangle-file "mallet_end_to_end_tutorial.org")'
#+end_example
