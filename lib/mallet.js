...
const testnets = {
  kevm: {
    rpc: 'https://mantis.kevm.dev.cardano.org/',
    faucet: 'https://faucet.kevm.dev.cardano.org/'
  },
...
function getUrls(base) {
  ...
  if (testnet !== undefined) {
    ...
    custom.host = null
    custom.hostname = "faucet." + custom.hostname.split(".").slice(1).join(".")
    const faucet = url.format(custom);
